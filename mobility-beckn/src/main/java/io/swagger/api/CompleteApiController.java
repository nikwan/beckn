...
public class CompleteApiController implements CompleteApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(CompleteApiController.class);
    ...
    public CompleteApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Object> completePost(@ApiParam(value = "TODO"  )  @Valid @RequestBody Object body
) {
