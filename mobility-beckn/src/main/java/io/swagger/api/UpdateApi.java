...
public interface UpdateApi {
    ...
    @ApiOperation(value = "", nickname = "updatePost", notes = "Remove object", response = Object.class, tags={ "Beckn App Facing API", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Object> updatePost(@ApiParam(value = "TODO"  )  @Valid @RequestBody Object body
);
