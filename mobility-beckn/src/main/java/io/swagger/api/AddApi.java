...
public interface AddApi {
    ...
    @ApiOperation(value = "", nickname = "addPost", notes = "Add a runtime object to a collection within a service instance object", response = Object.class, tags={ "Beckn App Facing API", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Object> addPost(@ApiParam(value = "TODO"  )  @Valid @RequestBody Object body
);
