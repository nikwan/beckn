...
public interface SearchApi {
    ...
    @ApiOperation(value = "", nickname = "searchPost", notes = "Search by intent", response = Object.class, tags={ "Beckn App Facing API", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Object> searchPost(@ApiParam(value = "Beckn App searches for the Services using an Intent."  )  @Valid @RequestBody SearchMobility body
);
