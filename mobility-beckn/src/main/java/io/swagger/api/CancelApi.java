...
public interface CancelApi {
    ...
    @ApiOperation(value = "", nickname = "cancelPost", notes = "Cancel a Service", response = Object.class, tags={ "Beckn App Facing API", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Object> cancelPost(@ApiParam(value = "TODO"  )  @Valid @RequestBody Object body
);
