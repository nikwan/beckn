...
public interface CompleteApi {
    ...
    @ApiOperation(value = "", nickname = "completePost", notes = "Complete a service", response = Object.class, tags={ "Beckn App Facing API", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Object> completePost(@ApiParam(value = "TODO"  )  @Valid @RequestBody Object body
);
