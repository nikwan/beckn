...
public class ListedValue {
    ...
    public ListedValue withIntegral(String integral) {
        this.integral = integral;
        return this;
    }
    ...
    public ListedValue withFractional(String fractional) {
        this.fractional = fractional;
        return this;
    }
    ...
    public ListedValue withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
