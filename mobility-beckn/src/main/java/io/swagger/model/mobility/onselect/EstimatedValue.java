...
public class EstimatedValue {
    ...
    public EstimatedValue withIntegral(String integral) {
        this.integral = integral;
        return this;
    }
    ...
    public EstimatedValue withFractional(String fractional) {
        this.fractional = fractional;
        return this;
    }
    ...
    public EstimatedValue withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
